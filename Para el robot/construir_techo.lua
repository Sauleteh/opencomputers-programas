--[[
	...
	en la esquina inferior izquierda mirando al frente y UN BLOQUE POR DEBAJO
	del techo a construir.
--]]
...
function techo(x,y)
	...
	for j = 1, x do
		...
		if (j ~= x) then
			...
			colocarArriba()
			print("Techo terminado")
		end
	end
end

local args = shell.parse(...)
techo(tonumber(args[1]), tonumber(args[2]))